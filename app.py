...
def get_ticker(equity):
    response = requests.get(
        'https://www.kensho.com/external/v1/search_entities?class_name=Equity&search_string=' + equity,
        headers={'Authorization': 'Token 75cabbcbb13902d342ab56354f2f24830b4ca92b'}).json()
